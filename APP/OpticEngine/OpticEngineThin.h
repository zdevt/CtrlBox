...
#ifndef  OPTICENGINETHIN_INC
#define  OPTICENGINETHIN_INC
...
#define  OPTIC_ENGINE_THIN_NAME   "YO_VSHG_P2WSLIM"

class OpticEngineThin : public OpticEngine
{
  public:
    explicit OpticEngineThin ( std::string engineName );
    virtual ~OpticEngineThin();
  ...
  public:
    ...
    virtual int SetChannelSource ( uint8_t type );
    virtual int GetChannelSource ( uint8_t& type );

    virtual int Check();
    virtual int CheckLedTempAndSetFanPwm();
