...
#ifndef  OPTICCOMPUTERMONITOR_INC
#define  OPTICCOMPUTERMONITOR_INC

#include <string>

#include "OpticEngine.h"

#define  COMPUTERMONITORNAME 				"LCD"

class ComputerMonitor : public OpticEngine
{
  public:
    explicit ComputerMonitor ( std::string engineName );
    virtual ~ComputerMonitor();
