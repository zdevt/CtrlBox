...
#ifndef  OPTICENGINEP4A_INC
#define  OPTICENGINEP4A_INC
...
#define  OPTIC_ENGINE_P4A_NAME   "YO_VAHG_P3APH"

class OpticEngineP4A : public OpticEngineThin
{
  public:
    explicit OpticEngineP4A ( std::string engineName );
    virtual ~OpticEngineP4A();
