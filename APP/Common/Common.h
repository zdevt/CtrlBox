...
/****************TCP********************/
#define BROADCAST_PORT            (17000)
#define UDPSERVER_PORT            (17000)
#define HEARTBEAT_REMOTE_PORT     (17001)

#define TCP_SERVER_CONFIG_PORT    (17002)
#define TCP_SERVER_ALARM_PORT     (17003)
#define TCP_SERVER_UPGRADE_PORT   (17004)
#define TCPSERVER_ECHO_PORT       (17009)
