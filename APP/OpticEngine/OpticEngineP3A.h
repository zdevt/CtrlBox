...
#ifndef  OPTICENGINEP3A_INC
#define  OPTICENGINEP3A_INC
...
/*   */
#define  OPTIC_ENGINE_P3A_NAME   "YO_VAHG_P3APH"

class OpticEngineP3A : public OpticEngineThin
{
  public:
    explicit OpticEngineP3A ( std::string engineName );
    virtual ~OpticEngineP3A();
