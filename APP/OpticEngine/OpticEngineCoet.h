...
#ifndef  OPTICENGINECOET_INC
#define  OPTICENGINECOET_INC
...
#define  OPTIC_ENGINE_COET_NAME   "COET_DH26_P2WPH"

class OpticEngineCoet : public OpticEngine
{
  public:
    explicit OpticEngineCoet ( std::string engineName );
    virtual ~OpticEngineCoet();
