...
#define MCP_VER_LEN       24
#define MCP_MODEL_LEN     24
#define MCP_STATUS_LEN    28

#define MCP_CHROMA_USEING_STR
#define MCP_CHROMA_LEN    (8)
...
enum EnumMcpSubtype
{
  ...
  MCP_CMD_SET_SCREENSTATE, /*  设置屏幕状态 */
  MCP_CMD_SET_ENGINESTATE_SERIAL,  /*设置光机开待机状态(串口专用)*/

  //查询版本
  MCP_CMD_VER_SOFTWARE = 0x6, /*查询软件版本信息*/
  MCP_CMD_VER_HARDWARE,   /*查询硬件版本信息*/
  MCP_CMD_VER_MFG,        /*查询单板制造信息*/
  MCP_CMD_SET_HARDWAREREVERSION, /*  设置硬件版本 */
  ...
  MCP_CMD_SET_USEPERIODENABLE = 0x20,/*设置使用期限是能*/
  MCP_CMD_GET_USEPERIODENABLE, /*获取使用期限是能*/
  MCP_CMD_SET_USEPERIOD,
  MCP_CMD_GET_USEPERIOD,
  MCP_CMD_GET_SERIALID,       /* 获取串口标识ID，串口通信专用指令 */
  ...
  MCP_CMD_SET_DOUBLEDESKTOP_SWITCHMODE, /*  设置主备桌面切换方式 */
  MCP_CMD_GET_DOUBLEDESKTOP_SWITCHMODE, /*  获取主备桌面切换方式 */
  MCP_CMD_SET_ENGINETYPE,       /*  设置光机类型 */
  MCP_CMD_SET_DESKTOPCOOR,      /*  设置桌面信号坐标 */
  MCP_CMD_GET_DESKTOPCOOR,      /*  获取桌面信号坐标 */
  MCP_CMD_GET_INPUTSIGNALRESOL, /*  获取输入信号分辨率 */
  MCP_CMD_SHOW_IP_SERIAL = 0x50, /*  显示IP地址，控制盒不回应答包*/
  ...
  MCP_CMD_SET_OPMNAME   = 0x70, /*设置光学参数模式名称*/
  ...
  MCP_CMD_SET_DCINDEX,
  MCP_CMD_GET_DCINDEX,
  MCP_CMD_GET_DCVALUE,          /*  获取占空比 */
  MCP_CMD_SET_DMDREGVAL = 0x80,
  MCP_CMD_GET_DMDREGVAL,
  MCP_CMD_SET_WPC,
  MCP_CMD_GET_WPC,
  MCP_CMD_SET_CCAENABLE,
  MCP_CMD_GET_CCAENABLE,
  MCP_CMD_SET_CCATARGET,
  MCP_CMD_GET_CCATARGET,
  MCP_CMD_SET_HSGVALUE,
  MCP_CMD_GET_HSGVALUE,
  MCP_CMD_SET_UCENABLE,          /* 设置一致性校正（Uniformity Correction）使能 */
  MCP_CMD_GET_UCENABLE,
  MCP_CMD_SET_UCSELPOS,
  MCP_CMD_SET_UCGAIN,
  MCP_CMD_GET_UCGAIN,
  MCP_CMD_SET_UCALLGAIN,
  MCP_CMD_GET_UCALLGAIN = 0x90,
  MCP_CMD_SET_UCRESET,
  MCP_CMD_SET_FANPWM,
  ...
  //光栅
  MCP_CMD_GET_WARPINGONLINESTATE = 0x120, /*  光栅板卡在线状态 */
  MCP_CMD_SET_WARPINGRESOL,  /*  设置光栅矫正分辨率 */
  MCP_CMD_GET_WARPINGRESOL,  /*  获取光栅矫正分辨率 */
  MCP_CMD_SET_WARPINGREDATA,
  MCP_CMD_SET_LUTCOEFF,  /*  设置查找表系数 */
  MCP_CMD_SET_WPLGCOEFF, /*  设置WPLG系数 */
  MCP_CMD_SET_LUTSET,    /*  设置查找表集合序号 */
  MCP_CMD_SET_WARPINGCOOR, /*  设置光栅矫正坐标 */
  MCP_CMD_GET_WARPINGCOOR,
  ...
  MCP_RET_GET_USEPERIODENABLE, /*返回使用期限是能*/
  MCP_RET_GET_USEPERIOD,   /* 返回使用期限*/
  ...
  MCP_RET_GET_DOUBLEDESKTOP_SWITCHMODE, /*  返回主备桌面切换方式 */
  MCP_RET_GET_DESKTOPCOOR, /*  返回桌面信号坐标 */
  MCP_RET_GET_INPUTSIGNALRESOL, /*  返回输入信号分辨率 */
  ...
  MCP_RET_GET_DCINDEX,            /*返回dc曲线 */
  MCP_RET_GET_DCVALUE,           	/*返回占空比 */
  MCP_RET_GET_DMDREGVAL,
  MCP_RET_GET_WPC,
  MCP_RET_GET_CCAENABLE,
  MCP_RET_GET_CCATARGET,
  MCP_RET_GET_HSGVALUE,
  MCP_RET_GET_UCENABLE,
  MCP_RET_GET_UCGAIN,
  MCP_RET_GET_UCALLGAIN,
  ...
  MCP_RET_GET_WARPINGONLINESTATE = 0x620, /*  返回矫正板卡在线状态 */
  MCP_RET_GET_WARPINGRESOL, /*  返回光栅矫正分辨率 */
  MCP_RET_GET_WARPINGCOOR,
